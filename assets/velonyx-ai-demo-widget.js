...
(function () {
  ...
  var CSS = ''
    ...
    + '.vx-demo-foot{padding:8px 14px 10px;border-top:1px solid rgba(212,175,55,0.12);'
    + 'font-size:0.66rem;color:rgba(255,255,255,0.5);text-align:center;letter-spacing:0.3px;}'
