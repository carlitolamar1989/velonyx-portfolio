...
**Version 2 — 2026-08-16.** Reviewed clause-by-clause against current California law and market-standard SaaS terms (see `REVIEW-plain-english.md`). Ready to publish once Carlos approves.
...
- **Velonyx** will defend and indemnify you against third-party claims that the Velonyx template code, as delivered by us and unmodified, infringes a US patent, copyright, or trademark. This does not cover your content, third-party services, modifications not made by us, or combinations we did not supply. If such a claim arises we may fix or replace the affected code or, if that is not commercially reasonable, end the Service and refund prepaid unused fees.
